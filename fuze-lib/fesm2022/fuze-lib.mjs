...
class DropdownListComponent {
  ...
  `, isInline: true, styles: [".dropdown{position:relative;display:inline-block;font-family:Montserrat,Nunito Sans,Helvetica Neue,Helvetica,Arial,sans-serif}.dropdown-button{width:200px;padding:10px 12px;background-color:#dc3e4e;color:#fff;border:none;cursor:pointer;border-radius:.5em;font-size:14px;font-weight:700;text-align:left;display:flex;justify-content:space-between;align-items:center}.dropdown-button.active{background-color:#b31c2d}.dropdown-button:hover{background-color:#a81424}.caret{margin-left:auto;border:6px solid transparent;border-top-color:#fff;display:inline-block;vertical-align:middle}.dropdown-menu{position:absolute;top:calc(100% + 5px);left:0;background-color:#fff;border:1px solid #ddd;border-radius:.5em;box-shadow:0 8px 16px #0003;list-style:none;margin:0;padding:5px 0;z-index:1;width:100%}.dropdown-item{padding:10px 12px;font-size:14px;color:#333;cursor:pointer}.dropdown-item:hover{background-color:#f5f5f5}.dropdown-item.selected{background-color:#dc3e4e;color:#fff;font-weight:700}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "directive", type: i1.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "directive", type: i1.NgForOf, selector: "[ngFor][ngForOf]", inputs: ["ngForOf", "ngForTrackBy", "ngForTemplate"] }, { kind: "directive", type: i1.NgIf, selector: "[ngIf]", inputs: ["ngIf", "ngIfThen", "ngIfElse"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.1", ngImport: i0, type: DropdownListComponent, decorators: [{
  ...
  `, styles: [".dropdown{position:relative;display:inline-block;font-family:Montserrat,Nunito Sans,Helvetica Neue,Helvetica,Arial,sans-serif}.dropdown-button{width:200px;padding:10px 12px;background-color:#dc3e4e;color:#fff;border:none;cursor:pointer;border-radius:.5em;font-size:14px;font-weight:700;text-align:left;display:flex;justify-content:space-between;align-items:center}.dropdown-button.active{background-color:#b31c2d}.dropdown-button:hover{background-color:#a81424}.caret{margin-left:auto;border:6px solid transparent;border-top-color:#fff;display:inline-block;vertical-align:middle}.dropdown-menu{position:absolute;top:calc(100% + 5px);left:0;background-color:#fff;border:1px solid #ddd;border-radius:.5em;box-shadow:0 8px 16px #0003;list-style:none;margin:0;padding:5px 0;z-index:1;width:100%}.dropdown-item{padding:10px 12px;font-size:14px;color:#333;cursor:pointer}.dropdown-item:hover{background-color:#f5f5f5}.dropdown-item.selected{background-color:#dc3e4e;color:#fff;font-weight:700}\n"] }]
        }], propDecorators: { items: [{
                type: Input
            }], selectedItem: [{
                type: Input
...
class TextboxComponent {
    ...
    />
  `, isInline: true, styles: [".textbox-container{position:relative;display:inline-block;font-family:Montserrat,Nunito Sans,Helvetica Neue,Helvetica,Arial,sans-serif}.textbox{display:inline-block;padding:10px 20px;font-size:16px;border:1px solid #ccc;border-radius:var(--textbox-border-radius, 25px);background-color:#fff;color:#333;box-sizing:border-box;transition:border-color .3s ease,transform .2s ease}.textbox:hover:not(:disabled){transform:scale(1.05);border-color:#dc3e4e}.textbox:focus{border-color:#dc3e4e;box-shadow:0 0 5px #dc3e4e80;outline:none}.textbox:disabled{background-color:#f0f0f0;color:#a0a0a0;cursor:not-allowed}.textbox::placeholder{color:#999;opacity:1}\n"], dependencies: [{ kind: "ngmodule", type: CommonModule }, { kind: "directive", type: i1.NgClass, selector: "[ngClass]", inputs: ["class", "ngClass"] }, { kind: "directive", type: i1.NgStyle, selector: "[ngStyle]", inputs: ["ngStyle"] }] });
}
i0.ɵɵngDeclareClassMetadata({ minVersion: "12.0.0", version: "19.0.1", ngImport: i0, type: TextboxComponent, decorators: [{
    ...
    <input
      ...
      (input)="onInputChange.emit($event)"
    />
  `, styles: [".textbox-container{position:relative;display:inline-block;font-family:Montserrat,Nunito Sans,Helvetica Neue,Helvetica,Arial,sans-serif}.textbox{display:inline-block;padding:10px 20px;font-size:16px;border:1px solid #ccc;border-radius:var(--textbox-border-radius, 25px);background-color:#fff;color:#333;box-sizing:border-box;transition:border-color .3s ease,transform .2s ease}.textbox:hover:not(:disabled){transform:scale(1.05);border-color:#dc3e4e}.textbox:focus{border-color:#dc3e4e;box-shadow:0 0 5px #dc3e4e80;outline:none}.textbox:disabled{background-color:#f0f0f0;color:#a0a0a0;cursor:not-allowed}.textbox::placeholder{color:#999;opacity:1}\n"] }]
